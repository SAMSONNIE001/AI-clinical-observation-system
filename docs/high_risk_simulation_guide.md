...
- No real cutting.
- No real head impact.
- No real fighting, attack, restraint, or physical contact.
...
| `blood_visible` | `dataset/raw/blood_visible` | Fake blood visible in the scene, not necessarily active bleeding |
...
| `fighting` | `dataset/raw/fighting` | Two people acting agitated from distance; no contact |
| `attack_on_person` | `dataset/raw/attack_on_person` | No-contact staged lunge or threatening posture; no contact and no real threat |
...
dataset/raw/fighting/fighting_002.mp4
